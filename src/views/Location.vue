...
import {Menu, Snapshot, MiniMap, DndPanel, SelectionSelect} from "@logicflow/extension";
import lfMockData from "../common/data/lfMockData";
import {theme, config} from "@/common/Config";
  ...
  setup() {
    ...
    onMounted(() => {
      const lf = new LogicFlow({
        ...config,
        plugins: [Menu, MiniMap, Snapshot, DndPanel, SelectionSelect],
